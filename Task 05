...
-- Even though the last one have multiple lines it is added
due to arithmetic '+' operator.
— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — -
...
--In if statement string is considered as true while empty string
is considered as false, but the string cannot be evaluated to true
when compared with relational operator (equality).
— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — -
